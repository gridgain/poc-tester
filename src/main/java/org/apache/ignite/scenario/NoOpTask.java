...
/**
 * Task joins cluster as a client and does nothing.
 */
public class NoOpTask extends AbstractTask {
    /** */
    private static final Logger LOG = LogManager.getLogger(NoOpTask.class.getName());
     ...
     */
    public NoOpTask(PocTesterArguments args, TaskProperties props){
        super(args, props);
    }

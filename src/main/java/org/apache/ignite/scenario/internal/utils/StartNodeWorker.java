...
import static org.apache.ignite.scenario.internal.utils.PocTesterUtils.*;
...
public class StartNodeWorker extends AbstractStartWorker {
    ...
    private String getStartCmd(PocTesterArguments args, final String host, final String dateTime, int cntr, int total,
        ...
        switch (nodeType) {
            case CLIENT:
                nodeStartCls = "org.apache.ignite.scenario.internal.TaskRunner";
            ...
            case SERVER:
                nodeStartCls = "org.apache.ignite.scenario.internal.utils.IgniteNode";

...
//        }
    ...
    /** */
    public static String findConsId(SSHCmdWorker worker, String host, NodeType type) throws Exception {
...
//        System.out.println(hms() + "Checking consistent id on the host " + host);
    ...
    /** */
    public static String findFreeJmxPort(SSHCmdWorker worker, String host) throws Exception {
...
//        System.out.println(hms() + "Checking jmxport on the host " + host);
    ...
    /** */
    public static String getRemoteJavaHome(SSHCmdWorker worker, String host) throws Exception {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (line.contains("property name=\"groupName\" value=\"cache_group")) {
                        ...
                        if (n0 % 2 == 0) {
                            ...
                            newList.add("                        <bean class=\"org.apache.ignite.scenario.internal.filters.OldestNodeFilter\"/>");

...
public class LocCmdWorker extends AbstractCmdWorker {
    private static final Logger LOG = LogManager.getLogger(LocCmdWorker.class.getName());

    /**
     *
     * @param args
     */
    public LocCmdWorker(PocTesterArguments args){
        super(args);
    };

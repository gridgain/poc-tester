...
import static org.apache.ignite.scenario.internal.TaskLooper.State.INIT;
import static org.apache.ignite.scenario.internal.TaskLooper.State.RUNNING;
import static org.apache.ignite.scenario.internal.TaskLooper.State.STOPPED;
...
class TaskLooper implements Runnable {
    ...
    /** */
    TaskLooper(GridTask task, String taskName, long timeToWork) {
        this.task = task;
    ...
    @NotNull protected String getTaskReport() throws Exception {
        if (state == INIT)

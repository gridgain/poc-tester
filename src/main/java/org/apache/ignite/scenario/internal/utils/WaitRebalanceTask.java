...
import org.apache.ignite.scenario.CheckBroadcastTask;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;

public class WaitRebalanceTask implements IgniteCallable<Boolean> {
    /** */
    private static final Logger LOG = LogManager.getLogger(WaitRebalanceTask.class.getName());
    ...
    public WaitRebalanceTask(long topVer, long timeout) {
        this.topVer = topVer;

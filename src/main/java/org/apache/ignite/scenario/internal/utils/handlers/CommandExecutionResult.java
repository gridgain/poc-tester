...
package org.apache.ignite.scenario.internal.utils.handlers;
...
public class CommandExecutionResult {
     ...
     * @param proc Process.
     */
    public CommandExecutionResult(int exitCode, List<String> outList, List<String> errList, Process proc) {

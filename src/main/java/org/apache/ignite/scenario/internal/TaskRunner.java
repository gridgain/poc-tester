...
public final class TaskRunner implements Runnable {
    /** */
    private static final Logger LOG = LogManager.getLogger(TaskRunner.class.getName());

    /** */
    private static final String DEFAULT_PACKAGE = "org.apache.ignite.scenario";
    ...
    /** */
    private TaskRunner(GridTask task) {
...
//        System.out.println("DEBUG_MSG threads = " + task.getThreads());
    ...
    private static void runTask(String[] args) throws Exception {
        ...
        args0.setArgsFromCmdLine(args, "TaskRunner");

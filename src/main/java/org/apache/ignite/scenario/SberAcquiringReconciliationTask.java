 ...
 */
public class SberAcquiringReconciliationTask extends AbstractSberbankTask {
    private static final Logger LOG = LogManager.getLogger(SberAcquiringReconciliationTask.class.getName());
    ...
    public SberAcquiringReconciliationTask(PocTesterArguments args) {
        super(args);
    }

    public SberAcquiringReconciliationTask(PocTesterArguments args, TaskProperties props) {
        super(args, props);
    }

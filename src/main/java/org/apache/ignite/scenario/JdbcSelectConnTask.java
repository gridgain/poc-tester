 ...
 */
public class JdbcSelectConnTask extends AbstractJdbcTask {
    /** */
    private static final Logger LOG = LogManager.getLogger(JdbcSelectConnTask.class.getName());
     ...
     */
    public JdbcSelectConnTask(PocTesterArguments args, TaskProperties props){
        super(args, props);
    }

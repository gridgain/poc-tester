...
import org.gridgain.poc.framework.worker.task.utils.TxCounter;
import org.gridgain.poc.tasks.GridTask;
import org.gridgain.poc.framework.worker.events.EventFileStorageImpl;
import org.gridgain.poc.framework.worker.events.EventRecord;
import org.gridgain.poc.framework.worker.events.EventStorage;
import org.gridgain.poc.framework.worker.events.TaskMetricsRecord;
import org.gridgain.poc.framework.worker.AbstractWorker;
import org.gridgain.poc.framework.starter.IgniteStarter;
import org.gridgain.poc.framework.utils.PocTesterUtils;
import org.gridgain.poc.framework.ssh.RemoteSshExecutor;
import org.gridgain.poc.framework.worker.StatWorker;
...
//    private static AtomicBoolean eventStorageCreated = new AtomicBoolean(false);
    ...
    private void startNode() {
        ...
        try {
            ignite = new IgniteStarter(true).start(args);
        }
        catch (Exception e) {

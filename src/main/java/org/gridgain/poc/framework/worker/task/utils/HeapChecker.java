...
import org.gridgain.poc.framework.ssh.CmdResult;
...
public class HeapChecker implements IgniteClosure<String, Long> {
    ...
    /** */
    private static final String checkCls = "org.gridgain.poc.framework.worker.task.utils.HeapDumpChecker";
        ...
        switch (checkType) {
            ...
            case REACHABLE_INSTANCES_SIZE:
                ...
                try {
                    ...
                    CmdResult res = worker.runLocCmd(cmd);

...
import org.gridgain.poc.framework.worker.charts.DataAssembler;
import org.gridgain.poc.framework.worker.charts.DstatLogWorker;
 ...
 */
public class SimpleChartWorker extends AbstractWorker {
    /** */
    private static final Logger LOG = LogManager.getLogger(SimpleChartWorker.class.getName());
    ...
    public static void main(String[] args) {
        new SimpleChartWorker().create(args);
    }

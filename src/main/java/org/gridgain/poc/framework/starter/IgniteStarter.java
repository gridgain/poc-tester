...
public class IgniteStarter {
    ...
    /** */
    public IgniteStarter() {
        // No-op.
    }

    /** */
    public IgniteStarter(boolean clientMode) {
        this.clientMode = clientMode;
    }

    /** */
    public IgniteStarter(boolean clientMode, Ignite ignite) {
        this.clientMode = clientMode;
        this.ignite = ignite;
    }

    /** */
    private static final Logger LOG = LogManager.getLogger(IgniteStarter.class.getName());

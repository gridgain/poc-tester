 ...
 */
public class JdbcPlainInsertTableTask extends AbstractJdbcTask {
    /** */
    private static final Logger LOG = LogManager.getLogger(JdbcPlainInsertTableTask.class.getName());
     ...
     */
    public JdbcPlainInsertTableTask(PocTesterArguments args, TaskProperties props){
        super(args, props);
    }

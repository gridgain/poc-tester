...
import org.gridgain.poc.framework.worker.task.utils.FileCleanerClosure;
import org.gridgain.poc.framework.worker.task.utils.HeapChecker;
import org.gridgain.poc.framework.worker.task.utils.HeapSizeCheckType;
import org.gridgain.poc.framework.worker.task.utils.NodeHeapInfo;
        ...
        for (int i = 0; i < nodesToCheck; i++) {
            ...
            if (heapInfoList == null) {
                ...
                if (res > firstSize * coefficient) {
                    ...
                    RemoteSshExecutor sshCmdWorker = new RemoteSshExecutor(args);
